    ...
    <>
      <div className="flex flex-col justify-around items-center h-screen bg-gray-100">
        ...
        <label className="input m-2 input-bordered flex items-center gap-2">
          ...
          <input type="text" onChange={(e) => setFirstName(e.target.value)} className="grow" placeholder="Firstname" />
        </label>
        <label className="input m-2 input-bordered flex items-center gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <input type="text" onChange={(e) => setLastName(e.target.value)} className="grow" placeholder="Lastname" />
        </label>
        <label className="input m-2 input-bordered flex items-center gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <label className="input m-2 input-bordered flex items-center gap-2">
          ...
          <input type="password" onChange={(e) => setConfirmPassword(e.target.value)} className="grow"  placeholder="ConfirmPassword" />
        </label>
